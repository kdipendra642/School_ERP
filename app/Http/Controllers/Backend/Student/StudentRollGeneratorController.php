...
class StudentRollGeneratorController extends Controller
{
    public function StudentRollView()
    {
        ...
        return view('backend.student.roll_generate.roll_gen_view', $data);
    }
    ...
    public function StudentRollStore(Request $request)
    {
        ...
        $notification = array(
            'message' => 'Students roll updated successfully.',
            'alert-type' => 'success',
        );
