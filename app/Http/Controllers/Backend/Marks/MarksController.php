...
class MarksController extends Controller
{
    ...
    public function MarksEntryGetStudentsEdit(Request $request)
    {
    ...
    public function MarksUpdate(Request $request)
    {
        ...
        StudentMarks::where('year_id', $year_id)->where('class_id', $class_id)->where('assign_subject_id', $assign_subject_id)->where('exam_type_id', $exam_type_id)->delete();
