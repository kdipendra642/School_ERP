                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="name" id="name" class="form-control" required value="{{ $editData['student']['name'] }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="fname" id="fname" class="form-control" required value="{{ $editData['student']['fname'] }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="mname" id="mname" class="form-control" required value="{{ $editData['student']['mname'] }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="tel" name="mobile" id="mobile" class="form-control" required value="{{ $editData['student']['mobile'] }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="address" id="address" class="form-control" required value="{{ $editData['student']['address'] }}">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="religion" id="religion" required="" class="form-control">
                                                    ...
                                                    <option value="Jain" {{ $editData['student']['religion'] == 'Jain' ? "selected" : "" }}>Jain</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="number" name="discount" id="discount" class="form-control" required value="{{ $editData['discount']['discount'] }}">
                                            </div>
                                        </div>
                                    </div>
