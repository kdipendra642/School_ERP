                ...
                <div class="col-12">
                    <div class="box bb-3 border-warning">
                        <div class="box-header">
                            <h4 class="box-title">Manage Marksheet View PDF</h4>
                        </div>

                        <div class="box-body" style="border: solid 1px; padding: 10px;">
                            <div class="row">
                                <div class="col-md-2 text-center" style="float: right; background-color: white;margin-left: 20px;">

                                    <img src="{{ url('upload/easyschool.png') }}" alt="" style="width: 120px; height: 100px; ">
                                </div>
                                ...
                                <div class="col-md-4 text-center">
                                    ...
                                    <h6><strong>Kathmandu, Nepal</strong></h6>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <table border="1" style="border-color: #fff; width: 98%; margin-left: 10px;" cellpadding="8" cellspacing="2">
                                        @php
