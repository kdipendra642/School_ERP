                            ...
                            <form method="post" action="{{ route('employee.registration.update', $editData->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="fname" id="fname" class="form-control" value="{{ $editData->fname }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="mname" id="mname" class="form-control" value="{{ $editData->mname }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="tel" name="mobile" id="mobile" class="form-control" value="{{ $editData->mobile }}">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="religion" id="religion" required="" class="form-control">
                                                    ...
                                                    <option value="Jain" {{ $editData->religion == 'Jain' ? "selected" : "" }}>Jain</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="date" name="dob" id="dob" class="form-control" required value="{{ $editData->dob }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row d-none">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="salary" id="salary" class="form-control" required value="{{ $editData->salary }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="date" name="join_date" id="join_date" class="form-control" required value="{{ $editData->join_date }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="controls">
                                                <img id="showImage" src="{{ (!empty($editData->image)) ? url('upload/employee_images/'.$editData->image) : url('upload/no_image.jpg') }}" alt="{{$editData->name }}" style="width: 100px; height: 100px; border: 1px solid #000;">
                                            </div>
                                        </div>
                                    </div>
