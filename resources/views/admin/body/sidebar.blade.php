        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ ($prefix == '/students') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ ($route == 'student.list.view' ) ? 'active' : '' }}"><a href="{{ route('student.list.view') }}"><i class="ti-more"></i>List All Student</a></li>
                    ...
                    <li class="{{ ($route == 'month.fee.view' ) ? 'active' : '' }}"><a href="{{ route('month.fee.view') }}"><i class="ti-more"></i>Monthly Fee</a></li>
            ...
            <li class="treeview {{ ($prefix == '/accounts') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ ($route == 'account.salary.view' ) ? 'active' : '' }}"><a href="{{ route('account.salary.view') }}"><i class="ti-more"></i>Employee Fee</a></li>
            ...
            <li class="treeview {{ ($prefix == '/reports') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ ($route == 'marksheet.generate.view' ) ? 'active' : '' }}"><a href="{{ route('marksheet.generate.view') }}"><i class="ti-more"></i>Marksheet Management</a></li>
